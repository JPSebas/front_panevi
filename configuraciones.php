...
<head>
    <!-- Configuración del conjunto de caracteres y vista adaptativa -->
    <meta charset="utf-8">
    ...
    <!-- Incluir la biblioteca SweetAlert2 para alertas -->
    ...
    <!-- Estilos externos (Bootstrap y Font Awesome) -->
    ...
    <!-- Cargar script de manera asíncrona -->
        ...
        <div class="container-logo">
            ...
            <div class="header-images">
                <div style="display: flex; align-items: center; color: white; text-align: center; margin-right: 5px;">
                    <!-- Mostrar nombre y apellido del usuario usando datos de sesión -->
                ...
                <!-- Mostrar imágenes del logo -->
                <img src="img/logo_nav (1).png" id="logo">
                <img src="img/P.PNG" alt="Imagen 1">
                <img src="img/A.png" alt="Imagen 2">
                <img src="img/N.png" alt="Imagen 3">
                <img src="img/E.png" alt="Imagen 4">
                <img src="img/V.png" alt="Imagen 5">
                <img src="img/I.png" alt="Imagen 6">
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsFurni">
                <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                    ...
                    <!-- Enlaces del menú -->
                    <li><a class="nav-link" href="perfil_cli.php">Inicio</a></li>
                    <li><a class="nav-link" href="quienes_somos.php">¿Quienes Somos?</a></li>
