...
<head>
    ...
    <!-- Controla la escala de la vista en dispositivos móviles -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <!-- Enlaza el archivo de estilo CSS específico para la página de perfil -->
    <link rel="stylesheet" href="../public/css/perfil1.css">

    <!-- Establece el icono de acceso rápido que aparece en la pestaña del navegador -->
    <link rel="shortcut icon" href="../public/img/acceso.png" type="image/x-icon">

    <!-- Enlaza la hoja de estilos de Font Awesome para usar iconos -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">

    <!-- Enlaza otra versión de la hoja de estilos de Font Awesome para compatibilidad -->
