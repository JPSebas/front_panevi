...
<!DOCTYPE html>
<html lang="en" class="light-mode"> <!-- Define el tipo de documento y establece el idioma a inglés -->

<head>
    <meta charset="UTF-8"> <!-- Define el tipo de codificación del documento -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0"> <!-- Configura la vista para dispositivos móviles -->
    <link rel="stylesheet" href="../public/css/perfil1.css"> <!-- Enlaza la hoja de estilos CSS externa -->
    <link rel="shortcut icon" href="../public/img/acceso.png" type="image/x-icon"> <!-- Define el icono de la pestaña -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"> <!-- Incluye los íconos de FontAwesome -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" rel="stylesheet"> <!-- Otra versión de FontAwesome -->

    <title>Administrador</title> <!-- Define el título de la página -->
</head>

<body>
    <svg style="display:none;"><!-- SVG oculto que contiene símbolos gráficos reutilizables -->
        <symbol id="logo" viewBox="0 0 140 59"><!-- Define un símbolo gráfico llamado "logo" con un área de vista específica -->
            <g><!-- Agrupa varios elementos gráficos -->
                <path
    ...
    <header class="page-header"> <!-- Encabezado de la página que contiene la barra de navegación. -->
        <nav> <!-- Contenedor de la barra de navegación. -->
            <a href="#0" aria-label="forecastr logo" class="logo"> <!-- Enlace al logo de la aplicación, accesible mediante un atributo aria-label. -->
                <h1><i>PANEVI</i></h1> <!-- Título principal de la aplicación, en cursiva. -->
                <img src="../public/img/logo_nav (1).png" width="100" alt=""> <!-- Imagen del logo, con un ancho de 100 píxeles y sin texto alternativo. -->
            </a>
            <button class="toggle-mob-menu" aria-expanded="false" aria-label="open menu"> <!-- Botón para abrir/cerrar el menú en dispositivos móviles, con atributos para accesibilidad. -->
                <svg width="20" height="20" aria-hidden="true"> <!-- SVG para el icono del botón. -->
                    <use xlink:href="#down"></use> <!-- Utiliza un símbolo SVG definido en otra parte del documento. -->
                </svg>
            </button>
            <ul class="admin-menu"> <!-- Lista de elementos del menú de administración. -->
                <li class="menu-heading"> <!-- Elemento de encabezado para la sección del menú. -->
                    <h3>Administración</h3> <!-- Título de la sección del menú. -->
                </li>
                <li> <!-- Elemento de la lista del menú. -->
                    <a href="../public/inicio_admi.php"> <!-- Enlace a la página de inicio de administración. -->
                        <svg> <!-- SVG para el icono del enlace. -->
                            <use xlink:href="#pages"></use> <!-- Utiliza un símbolo SVG definido en otra parte del documento. -->
                        </svg>
                        <span>Inicio</span> <!-- Texto del enlace. -->
                    </a>
                </li>
                <li> <!-- Otro elemento de la lista del menú. -->
                    <a href="../public/confi_admi.php"> <!-- Enlace a la página de configuración de administración. -->
                        <svg> <!-- SVG para el icono del enlace. -->
                            <use xlink:href="#options"></use> <!-- Utiliza un símbolo SVG definido en otra parte del documento. -->
                        </svg>
                        <span>Configuración</span> <!-- Texto del enlace. -->
                    </a>
                </li>
                <li> <!-- Otro elemento de la lista del menú. -->
                    <a href="../public/clien_admi.php"> <!-- Enlace a la página de clientes de administración. -->
                        <svg> <!-- SVG para el icono del enlace. -->
                            <use xlink:href="#users"></use> <!-- Utiliza un símbolo SVG definido en otra parte del documento. -->
                        </svg>
                        <span>Clientes</span> <!-- Texto del enlace. -->
                    </a>
                </li>
                <li> <!-- Otro elemento de la lista del menú. -->
                    <a href="../public/productos_admin.php"> <!-- Enlace a la página de productos de administración. -->
                        <svg> <!-- SVG para el icono del enlace. -->
                            <use xlink:href="#collection"></use> <!-- Utiliza un símbolo SVG definido en otra parte del documento. -->
                        </svg>
                        <span>Productos</span> <!-- Texto del enlace. -->
                    </a>
                </li>
                <li> <!-- Otro elemento de la lista del menú. -->
                    <a href="../public/pedidos_admi.php"> <!-- Enlace a la página de pedidos de administración. -->
                        <svg> <!-- SVG para el icono del enlace. -->
                            <use xlink:href="#collection"></use> <!-- Utiliza un símbolo SVG definido en otra parte del documento. -->
                        </svg>
                        <span>Pedidos</span> <!-- Texto del enlace. -->
                    </a>
                </li>
                <li> <!-- Otro elemento de la lista del menú. -->
                    <a href="../public/factu_envios.php"> <!-- Enlace a la página de facturas y envíos de administración. -->
                        <svg> <!-- SVG para el icono del enlace. -->
                            <use xlink:href="#pages"></use> <!-- Utiliza un símbolo SVG definido en otra parte del documento. -->
                        </svg>
                        <span>Facturas y envíos</span> <!-- Texto del enlace. -->
                    </a>
                </li>
                <li> <!-- Otro elemento de la lista del menú. -->
                    <a href="../public/logout.php"> <!-- Enlace para cerrar sesión. -->
                        <svg> <!-- SVG para el icono del enlace. -->
                            <use xlink:href="#logout"></use> <!-- Utiliza un símbolo SVG definido en otra parte del documento. -->
                        </svg>
                        <span>Cerrar Sesión</span> <!-- Texto del enlace. -->
                    </a>
                </li>
                <svg style="display: none;"> <!-- SVG oculto que define símbolos utilizados en el menú. -->
                    <symbol id="logout" viewBox="0 0 24 24"> <!-- Definición del símbolo de cierre de sesión. -->
                        <path d="M10 9v-6h8v18h-8v-6h-2v8h12v-20h-12v8h2zm-6 7l-4-4 4-4v3h9v2h-9v3z" /> <!-- Forma del icono. -->
                    </symbol>
                </svg>
                <li> <!-- Otro elemento de la lista del menú. -->
                    <div class="switch"> <!-- Contenedor para el interruptor de modo oscuro. -->
                        <input type="checkbox" id="mode" checked> <!-- Checkbox que permite cambiar entre modo claro y oscuro, inicialmente en modo oscuro. -->
                        <label for="mode"> <!-- Etiqueta para el checkbox. -->
                            <span></span> <!-- Span adicional para el diseño del interruptor. -->
                            <span>Dark</span> <!-- Texto que indica que es el modo oscuro. -->
                        </label>
                    </div>
                    <button class="collapse-btn" aria-expanded="true" aria-label="collapse menu"> <!-- Botón para colapsar el menú. -->
                        <svg aria-hidden="true"> <!-- SVG para el icono del botón de colapso. -->
                            <use xlink:href="#collapse"></use> <!-- Utiliza un símbolo SVG definido en otra parte del documento. -->
                        </svg>
                    </button>
                </li>
            </ul>
