...
<body>
	...
	<footer class="footer-section">
		<!-- Contenedor principal para el pie de página -->
		<div class="container relative">

			<!-- Fila que contiene las columnas del pie de página -->
			<div class="row g-5 mb-5">
				<!-- Primera columna que contiene el logo y enlaces sociales -->
				<div class="col-lg-4">
					<!-- Logo del sitio, con estilo de tamaño y color -->
					<div class="mb-4 footer-logo-wrap" style="font-size: 45px;color: white"><span>PANEVI</span></div>

					<p class="mb-4"></p> <!-- Espacio vacío, posiblemente para futuras descripciones -->
				...
				<!-- Segunda columna que contiene enlaces adicionales -->
				<div class="col-lg-8">
					<!-- Fila que contiene los enlaces agrupados -->
					<div class="row links-wrap">
						<!-- Primera sección de enlaces (Información) -->
						...
						<!-- Segunda sección de enlaces (Mi Cuenta) -->
						<div class="col-6 col-sm-6 col-md-3">
							<ul class="list-unstyled">
								...
								<!-- Enlace a "Mi información" -->
								<li><a href="#" style="color: grey">Mi información</a></li>
							</ul>
						</div>

						<!-- Tercera sección de enlaces (Contacto) -->
						<div class="col-6 col-sm-6 col-md-3">
							<ul class="list-unstyled">
								<!-- Título de la sección -->
						...
						<!-- Cuarta columna vacía, puede ser utilizada para enlaces futuros -->
						<div class="col-6 col-sm-6 col-md-3">
							<ul class="list-unstyled">
								<li><a href="#"></a></li>
								<li><a href="#"></a></li>
			...
			<div class="border-top copyright">
				<div class="row pt-4">
					<!-- Columna para derechos de autor y contacto -->
					<div class="col-lg-6">
						<!-- Texto que muestra los derechos de autor y el correo de contacto -->
						<p class="mb-2 text-center text-lg-start">Derechos de Autor &copy;
							...
							<!-- Información sobre la licencia del sitio -->
