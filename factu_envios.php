...
<head>
    ...
    <!-- Configura la vista para dispositivos móviles, ajustando el ancho a la pantalla del dispositivo -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <!-- Enlaza una hoja de estilos CSS específica para el perfil -->
    <link rel="stylesheet" href="../public/css/perfil1.css">

    <!-- Establece un ícono que se mostrará en la pestaña del navegador -->
    <link rel="shortcut icon" href="../public/img/acceso.png" type="image/x-icon">

    <!-- Enlaza la hoja de estilos de Font Awesome para utilizar iconos -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">

    <!-- Enlaza una versión anterior de la hoja de estilos de Font Awesome -->
    ...
    <header class="page-header">
        ...
        <nav>
            ...
            <a href="#0" aria-label="forecastr logo" class="logo">
                <h1><i>PANEVI</i></h1> <!-- Nombre del sitio, estilizado con un ícono -->
                <img src="../public/img/logo_nav (1).png" width="100" alt=""> <!-- Logo de la empresa -->
            </a>
            <!-- Botón para alternar el menú en dispositivos móviles -->
            <button class="toggle-mob-menu" aria-expanded="false" aria-label="open menu">
                <svg width="20" height="20" aria-hidden="true"> <!-- Icono SVG para el botón -->
                    <use xlink:href="#down"></use> <!-- Referencia a un símbolo SVG definido en otro lugar -->
                </svg>
            </button>
            <!-- Lista de menú para la administración -->
            <ul class="admin-menu">
                <li class="menu-heading">
                    <h3>Administración</h3> <!-- Encabezado del menú -->
                </li>
                <li>
                    <!-- Enlace a la página de inicio de administración -->
                    <a href="../public/inicio_admi.php">
                        <svg> <!-- Icono SVG para el enlace -->
                            <use xlink:href="#pages"></use> <!-- Referencia a un símbolo SVG -->
                        </svg>
                        <span>Inicio</span> <!-- Texto del enlace -->
                    </a>
                </li>
                <li>
                    <!-- Enlace a la configuración de administración -->
                    <a href="../public/confi_admi.php">
                        <svg>
                            <use xlink:href="#options"></use> <!-- Icono SVG para la configuración -->
                        </svg>
                ...
                <li>
                    ...
                    <a href="../public/clien_admi.php">
                        <svg>
                            <use xlink:href="#users"></use> <!-- Icono SVG para los clientes -->
                        </svg>
                ...
                <li>
                    ...
                    <a href="../public/productos_admin.php">
                        <svg>
                            <use xlink:href="#collection"></use> <!-- Icono SVG para los productos -->
                        </svg>
                        <span>Productos</span> <!-- Texto del enlace -->
                    </a>
                </li>
                <li>
                    <!-- Enlace a la gestión de pedidos -->
                    <a href="../public/pedidos_admi.php">
                        <svg>
                            <use xlink:href="#collection"></use> <!-- Icono SVG para los pedidos -->
                        </svg>
                        <span>Pedidos</span> <!-- Texto del enlace -->
                    </a>
                </li>
                <li>
                    <!-- Enlace a las facturas y envíos -->
                    <a href="../public/factu_envios.php">
                        <svg>
                            <use xlink:href="#pages"></use> <!-- Icono SVG para las facturas y envíos -->
                        </svg>
                ...
                <li>
                    ...
                    <a href="../public/logout.php">
                        <svg>
                            <use xlink:href="#logout"></use> <!-- Icono SVG para cerrar sesión -->
                        </svg>
                        <span>Cerrar Sesión</span> <!-- Texto del enlace -->
                    </a>
                </li>
                <svg style="display: none;">
                    <!-- Definición del símbolo SVG para cerrar sesión -->
                ...
                <li>
                    <div class="switch">
                        ...
                        <label for="mode">
                            <span></span>
                            <span>Dark</span> <!-- Etiqueta para el interruptor, indicando el modo oscuro -->
                        </label>
                    </div>
                    <!-- Botón para colapsar el menú -->
                    <button class="collapse-btn" aria-expanded="true" aria-label="collapse menu">
                        <svg aria-hidden="true">
                            <use xlink:href="#collapse"></use> <!-- Referencia a un símbolo SVG para el colapso -->
                        </svg>
                    </button>
                </li>
            </ul>
